 ...
 * 
 * Uso:
 * Ejecuta este script con Node.js: node src/scripts/test-trafico-commonjs.js
 */
...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.log('Fallo esperado:', error.message);
    }
 ...
 */
async function probarAPI(params, mostrarDetalles = true) {
